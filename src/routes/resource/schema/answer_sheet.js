...
var answer_sheet_schema = new Schema({
    user: {type: mongoose.Schema.ObjectId, ref:'user', index: true},//用户id
    question: {type: mongoose.Schema.ObjectId, ref:'question', index: true},//问题id
    paper:{type: mongoose.Schema.ObjectId, ref:"paper", index: true},//试卷id
